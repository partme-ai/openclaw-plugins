...
export const EXTENSION_INVENTORY = [
  ...
  { id: "douyin", filter: "@partme.ai/openclaw-douyin", dir: "extensions/douyin", type: "channel", category: "webhook-platform", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "rednode", filter: "@partme.ai/openclaw-rednode", dir: "extensions/rednode", type: "capability", category: "capability", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "amap", filter: "@partme.ai/openclaw-amap", dir: "extensions/amap", type: "capability", category: "capability", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "meituan", filter: "@partme.ai/openclaw-meituan", dir: "extensions/meituan", type: "capability", category: "capability", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "bridge", filter: "@partme.ai/openclaw-bridge", dir: "extensions/bridge", type: "capability", category: "infra", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  ...
  { id: "nacos", filter: "@partme.ai/openclaw-nacos", dir: "extensions/nacos", type: "infra", category: "infra", e2eAdapter: true, dockerRequired: true, dockerServices: ["nacos"] },
  ...
  { id: "prometheus", filter: "@partme.ai/openclaw-prometheus", dir: "extensions/prometheus", type: "infra", category: "infra", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "knowledge", filter: "@partme.ai/openclaw-knowledge", dir: "extensions/knowledge", type: "capability", category: "capability", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "memory", filter: "@partme.ai/openclaw-memory", dir: "extensions/memory", type: "memory", category: "memory", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
  { id: "openmem", filter: "@partme.ai/openclaw-openmem", dir: "extensions/openmem", type: "memory", category: "memory", e2eAdapter: true, dockerRequired: false, dockerServices: [] },
...
export const PLUGIN_REGISTRY = [
  ...
  },
  {
    id: "nacos",
    category: "infra",
    filter: "@partme.ai/openclaw-nacos",
    dir: "extensions/nacos",
    extDir: "openclaw-nacos-candidate",
    channels: [],
    dockerServices: ["nacos"],
    needsGotify: false,
    browserTest: false,
    isolated: true,
  },
  {
    id: "bridge",
    category: "infra",
    filter: "@partme.ai/openclaw-bridge",
    dir: "extensions/bridge",
    extDir: "openclaw-bridge-candidate",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  },
  {
    id: "wecom-kf",
    category: "webhook-platform",
    filter: "@partme.ai/wecom-kf",
    dir: "extensions/wecom-kf",
    extDir: "wecom-kf-candidate",
    channels: ["wecom-kf"],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "wechat-ipad",
    category: "webhook-platform",
    filter: "@partme.ai/wechat-ipad",
    dir: "extensions/wechat-ipad",
    extDir: "wechat-ipad-candidate",
  ...
  },
  {
    ...
    // 候选解包目录不能与宿主按 manifest id 创建的正式链接目录同名。
    extDir: "openclaw-weixin-candidate",
  ...
  },
  {
    id: "rednode",
    category: "capability",
    filter: "@partme.ai/openclaw-rednode",
    dir: "extensions/rednode",
    extDir: "openclaw-rednode",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "meituan",
    category: "capability",
    filter: "@partme.ai/openclaw-meituan",
    dir: "extensions/meituan",
    extDir: "openclaw-meituan",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "amap",
    category: "capability",
    filter: "@partme.ai/openclaw-amap",
    dir: "extensions/amap",
    extDir: "openclaw-amap",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "douyin",
    category: "webhook-platform",
    filter: "@partme.ai/openclaw-douyin",
    dir: "extensions/douyin",
    extDir: "openclaw-douyin",
    channels: ["douyin"],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "knowledge",
    category: "capability",
    filter: "@partme.ai/openclaw-knowledge",
    dir: "extensions/knowledge",
    extDir: "openclaw-knowledge",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "openmem",
    category: "memory",
    filter: "@partme.ai/openclaw-openmem",
    dir: "extensions/openmem",
    extDir: "openclaw-openmem",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "memory",
    category: "memory",
    filter: "@partme.ai/openclaw-memory",
    dir: "extensions/memory",
    extDir: "openclaw-memory",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,
  ...
  },
  {
    id: "prometheus",
    category: "infra",
    filter: "@partme.ai/openclaw-prometheus",
    dir: "extensions/prometheus",
    extDir: "openclaw-prometheus",
    channels: [],
    dockerServices: [],
    needsGotify: false,
    browserTest: false,

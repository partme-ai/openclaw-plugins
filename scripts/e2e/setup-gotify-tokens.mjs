 ...
 * Writes secrets to scripts/e2e/.e2e-secrets.json (gitignored pattern).
 */
...
async function main() {
  ...
  writeFileSync(`${E2E_DIR}/.e2e-secrets.json`, JSON.stringify(secrets, null, 2));
  console.log("[gotify-setup] tokens written (appId=%s)", app.id);
}

...
const configSchema = {
  ...
  properties: {
    ...
    timeoutMs: { type: "number" as const, minimum: 100, maximum: 120000, default: 5000 },
    maxAttempts: { type: "number" as const, minimum: 1, maximum: 5, default: 3 },
    retryBaseDelayMs: { type: "number" as const, minimum: 0, maximum: 5000, default: 100 },
    maxResponseBytes: { type: "number" as const, minimum: 1024, maximum: 16777216, default: 2097152 },
    allowSharedRecall: { type: "boolean" as const, default: false },
    apiKeyEnv: { type: "string" as const },
    authHeader: { type: "string" as const, default: "Authorization" },
    authScheme: { type: "string" as const, default: "Bearer" },
  },
};

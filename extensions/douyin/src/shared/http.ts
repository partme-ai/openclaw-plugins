...
import { resolveDouyinEgressProxyUrl } from "../config/resolvers.js";

const USER_AGENT = "OpenClaw/2.0 (Douyin-Channel)";

/**
 * 带代理与超时的 HTTP 请求。
 */
export async function douyinFetch(

...
import { resolveMtlsConfig } from "./config.js";
...
const configSchema = {
  ...
  properties: {
    ...
    tls: { type: "object" as const, additionalProperties: true },
    proxy: { type: "object" as const, additionalProperties: true },
    protectedPaths: { type: "array" as const, items: { type: "object" as const } },
    allowedClients: { type: "array" as const, items: { type: "object" as const } },
    skipPaths: { type: "array" as const, items: { type: "string" as const } },
    passthrough: { type: "boolean" as const, default: false },
...
export { resolveMtlsConfig } from "./config.js";

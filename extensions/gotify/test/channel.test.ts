...
vi.mock('../src/transport/gotify-api.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../src/transport/gotify-api.js')>();
  return {
    ...actual,
...
import { deleteMessage, resolveApplicationName, sendGotifyMessageWithDeliveryRetry } from '../src/transport/gotify-api.js';

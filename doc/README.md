...
| — | [插件目录结构与命名规范（强规范 / Normative）](./OpenClaw-Plugins-Structure-Standard.md) |
...
| 插件 | 文档入口 | 说明 |
|------|----------|------|
| **wecom** | [Configuration](./wecom/OpenClaw-WeCom-Configuration.md) · [配置指南](./wecom/OpenClaw-WeCom-Configuration.zh-CN.md) · [架构 / Architecture](./wecom/OpenClaw-WeCom-Architecture.md) · [流式 / Streaming](./wecom/OpenClaw-WeCom-Streaming-Architecture.md) · [联调 / Testing](./wecom/OpenClaw-WeCom-Testing.md) · [Checklist](./wecom/OpenClaw-WeCom-Integration-Checklist.md) | 企业微信自建插件 |

...
| 插件 | 文档入口 | 说明 |
|------|----------|------|
| **wecom** | [配置指南 / Configuration](./wecom/OpenClaw-WeCom-Configuration.md) · [架构 / Architecture](./wecom/OpenClaw-WeCom-Architecture.md) · [流式 / Streaming](./wecom/OpenClaw-WeCom-Streaming-Architecture.md) · [联调 / Testing](./wecom/OpenClaw-WeCom-Testing.md) · [Feishu SDK 对照](./wecom/OpenClaw-WeCom-Feishu-SDK-Inventory.md) | 企业微信自建插件 |
